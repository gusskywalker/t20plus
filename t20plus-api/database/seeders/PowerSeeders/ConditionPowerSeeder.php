...
class ConditionPowerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'passive',
            'icon_file_name' => 'apavorado_01.webp',
            'effects' => [
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'passive',
            'icon_file_name' => 'abalado_01.webp',
            'effects' => [
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'roleplay',
            'icon_file_name' => 'enjoado_01.webp',
        ]);
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'passive',
            'icon_file_name' => 'enredado_01.webp',
            'effects' => [
                ['tag' => 'mod_movement', 'op' => 'multiply', 'value' => 0.5],
                ['tag' => 'mod_def', 'op' => 'add', 'value' => -2],
                ['tag' => 'mod_hit', 'op' => 'add', 'value' => -2],
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'roleplay',
            'icon_file_name' => 'fome_sede_01.webp',
        ]);
        ...
        Power::create([
            ...
            'source' => 'condition_granted',
            'usability' => 'passive',
            'icon_file_name' => 'fascinado_01.webp',
            'effects' => [
